...
; (function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn bg-padrao sw-btn-next text-white').attr('type', 'button') : null;
            ...
            var btnGroup = $('<div></div>').addClass('btn-group mt-4  m-auto sw-btn-group').attr('role', 'group').append(btnPrevious, btnNext);
